...
A [!UICONTROL Audit Trail] registra e lista as ações do operador, como criação, modificação e exclusão de fluxos de trabalho, opções e esquemas de origem. Além disso, as seguintes ações são registradas especificamente para fluxos de trabalho:
...
>[!VIDEO](https://video.tv.adobe.com/v/33966?captions=por_br&quality=12&learn=on){transcript=true}
